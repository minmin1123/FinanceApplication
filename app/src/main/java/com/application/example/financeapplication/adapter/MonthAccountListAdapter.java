...
public class MonthAccountListAdapter extends BaseAdapter {
    ...
    public MonthAccountListAdapter(Context context, int resource, List<Account> objects) {
        super();
        mConext = context;
        resourceId = resource;
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        holder.mDateTv.setText(account.getYear()+"-"+account.getMonth()+"-"+account.getDay());
