...
public class DateUtils {
    ...
    //得到给定时间的后一天
    public static List<String> theDayBefore(String old_year, String old_month, String old_day){
        int  now_year= Integer.parseInt(old_year);
        int  now_month= Integer.parseInt(old_month);
        int  now_day= Integer.parseInt(old_day);
        int  selected_year=0;
        ...
        int  selected_day=0;
        if(now_month==5||now_month==7||now_month==10||now_month==12){
            if(now_day==1){
                selected_day=30;
                selected_month=now_month-1;
                selected_year=now_year;
            }else{
                selected_day=now_day-1;
                selected_month=now_month;
                selected_year=now_year;
            }
        }else if(now_month==2||now_month==4||now_month==6||now_month==8||now_month==9||now_month==11){
            if(now_day==1){
                selected_day=31;
                selected_month=now_month-1;
                selected_year=now_year;
        ...
        dateList.add(selected_year+"");
        dateList.add(selected_month+"");
        dateList.add(selected_day+"");
        return dateList;
    }

    //得到给定时间的后一天
    public static List<String> theDayAfter(String old_year, String old_month, String old_day){
        int  now_year= Integer.parseInt(old_year);
        int  now_month= Integer.parseInt(old_month);
        int  now_day= Integer.parseInt(old_day);
        int  selected_year=0;
